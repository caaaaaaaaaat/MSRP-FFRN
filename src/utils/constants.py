...
# # CLASSIFIERS = ['FCN_torch','ResNet_torch', 'Inception_torch', 'IFCN_torch', 'FFRN_torch', 'IRN_torch', 'AlexNet_torch', 'CNN_torch']
...
def parse_args():
    ...
    parser.add_argument('--CLASSIFIERS', type=str, default='FFRN_torch',
...
def create_classifier(classifier_name, nb_classes):
    if classifier_name == 'FCN_torch':
        from src.classifiers import FCN_torch
    ...
    if classifier_name == 'ResNet_torch':
        from src.classifiers import ResNet_torch
    ...
    if classifier_name == 'Inception_torch':
        from src.classifiers import Inception_torch
    ...
    if classifier_name == 'IFCN_torch':
        from src.classifiers import IFCN_torch
        # __init__(self, in_channels, out1_channels_1, out1_channels_2, out1_channels_3,
        #          out1_channels_4, out2_channels_1, out2_channels_2, out2_channels_3,
        #          out2_channels_4, num_class)
        # return IFCN_torch.IFCN(1, 16, 32, 96, 16, 32, 64, 192, 32, nb_classes), IFCN_torch
        return IFCN_torch.IFCN(1, 8, 64, 64, 8, 16, 32, 96, 16, nb_classes), IFCN_torch

    if classifier_name == 'FFRN_torch':
        from src.classifiers import FFRN_torch
        # __init__(self, in_channels, out1_channels_1, out1_channels_2, out1_channels_3,
        #          out1_channels_4, out2_channels_1, out2_channels_2, out2_channels_3,
        #          out2_channels_4, num_class)
        # return IFCN_torch.IFCN(1, 16, 32, 96, 16, 32, 64, 192, 32, nb_classes), IFCN_torch
        return FFRN_torch.FFRN(1, 8, 64, 64, 8, 16, 32, 96, 16, nb_classes), FFRN_torch

    if classifier_name == 'IRN_torch':
        from src.classifiers import IRN_torch
